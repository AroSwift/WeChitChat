...
function badw($string){

if($string){

strtolower($string);

$swear = array("bloody", "shit", "fuck", "sex", "sexy", "naked", "nude", "boobs", "bastered", "damn");
$replace = '<span class="badw">[Bad word]</span>';

$newstring = str_replace($swear, $replace, $string);
...
<meta name="Keywords" content="<?php if(isset($key)){ echo $key; } else { ?>we chit chat, chit chat, safe chatting, kids chat room, kids chat, teens chat, free chatting for kids, free chatting <?php } ?>" />
<meta name="Description" content="<?php if(isset($des)){ echo $des; } else { ?>WeChitChat is a secure and safe place for young kids and teens to chat.<?php } ?>" />
